...
objects it manipulates are all in ``games/spiders/``, with your very own
AI living in ``games/spiders/ai.py`` for you to make smarter.
...
school's S-Drive implimentation changing some file permissions during
